...
public class CameraSource
{
    ...
    public static class Builder {
        ...
        public CameraSource build()
        {
            ...
            // SN
            mCameraSource.mFrameProcessor = mCameraSource.new FrameProcessingRunnable(mDetector, mCameraSource.mFocusMode);
    ...
    private Camera createCamera()
    {
        ...
        //SizePair sizePair = selectSizePairMaxWidth(camera);
        if (sizePair == null) {
        ...
        if (mFocusMode != null) {
            ...
            if (parameters.getSupportedFocusModes() != null &&   // TODO SN addition
        ...
        if (mFlashMode != null) {
            if (parameters.getSupportedFlashModes() != null &&   // SN addition
    ...
    private static SizePair selectSizePair(Camera camera, int desiredWidth, int desiredHeight) {
        ...
        for (SizePair sizePair : validPreviewSizes)
        {
            ...
            //Log.i(TAG, "selectSizePair() validPreviewSize "+size);
    ...
    /**
     * Selects the preview and picture size with maximal width.
     * <p/>
     * Even though we may only need the preview size, it's necessary to find both the preview
     * size and the picture size of the camera together, because these need to have the same aspect
     * ratio.  On some hardware, if you would only set the preview size, you will get a distorted
     ...
     * @return the selected preview and picture size pair
     */
    private static SizePair selectSizePairMaxWidth(Camera camera)
    {
        List<SizePair> validPreviewSizes = generateValidPreviewSizeList(camera);
    ...
    /**
     * Selects the preview and picture size with maximal height.
     * <p/>
     * Even though we may only need the preview size, it's necessary to find both the preview
     * size and the picture size of the camera together, because these need to have the same aspect
     * ratio.  On some hardware, if you would only set the preview size, you will get a distorted
     ...
     * @return the selected preview and picture size pair
     */
    private static SizePair selectSizePairMaxHeight(Camera camera)
    {
        List<SizePair> validPreviewSizes = generateValidPreviewSizeList(camera);
    ...
    private class FrameProcessingRunnable implements Runnable {
        ...
        // SN
        private boolean _manualAutoFocus = false;
        private long _countFrames = 0;
        // End of SN
        ...
        // SN
        FrameProcessingRunnable(Detector<?> detector, String focusMode)
        {
            mDetector = detector;
            if (Camera.Parameters.FOCUS_MODE_AUTO.equals(focusMode))
            {
                _manualAutoFocus = true;
            }
        }
        ...
        boolean isManualAutoFocus()
        {
            return _manualAutoFocus;
        }

        void setManualAutoFocus(boolean manualAutoFocus)
        {
            _manualAutoFocus = manualAutoFocus;
        }
        ...
        public void run() {
            ...
            while (true) {
                ...
                try
                {
                    ...
                    if (_manualAutoFocus) _countFrames++; // SN
                }
                catch (Throwable t) {
                ...
                finally
                {
                    ...
                    // SN main trick for camera w/o continuous-picture
                    if (_manualAutoFocus && _countFrames % 30 == 0)
                    {
